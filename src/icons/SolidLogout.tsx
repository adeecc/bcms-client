...
const SvgLogout = (props: React.SVGProps<SVGSVGElement>) => {
    return (
      ...
      >
        ...
        <path
          xmlns="http://www.w3.org/2000/svg"
          d="M505.75 198.254l-85.336-85.332a21.33 21.33 0 00-23.25-4.633C389.207 111.598 384 119.383 384 128.004v64h-85.332c-11.777 0-21.336 9.555-21.336 21.332 0 11.777 9.559 21.332 21.336 21.332H384v64c0 8.621 5.207 16.406 13.164 19.715a21.335 21.335 0 0023.25-4.63l85.336-85.335c8.34-8.34 8.34-21.824 0-30.164zm0 0"
          fill="#fff"
          data-original="#000000"
        />
      </svg>
